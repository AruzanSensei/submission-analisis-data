...
st.write(
    ...
    _  1. Bagaimana pola jumlah penyewaan sepeda berdasarkan waktu, baik secara jam maupun bulanan? Pada jam dan bulan berapa penyewaan meningkat?_
    _  2. Seberapa sering pelanggan menyewa sepeda dalam beberapa bulan terakhir?_
    _  3. Pada musim apa jumlah penyewaan sepeda mencapai puncaknya?_
    """
)
